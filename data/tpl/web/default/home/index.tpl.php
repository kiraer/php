...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>微动力 - 微信公众平台开源管理系统-b2ctui.com<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
<meta name="keywords" content="<?php  if(empty($_W['setting']['copyright']['keywords'])) { ?>微动力,微信,微信公众平台<?php  } else { ?><?php  echo $_W['setting']['copyright']['keywords'];?><?php  } ?>" />
<meta name="description" content="<?php  if(empty($_W['setting']['copyright']['description'])) { ?>微信公众平台自助引擎，简称微动力，微动力是一款开源的微信公众平台管理系统。<?php  } else { ?><?php  echo $_W['setting']['copyright']['description'];?><?php  } ?>" />
...
<h1 class="logo"><a href="/" title=""><img src="<?php  if(!empty($_W['setting']['copyright']['flogo'])) { ?><?php  echo $_W['attachurl'];?><?php  echo $_W['setting']['copyright']['flogo'];?><?php  } else { ?>./resource/image/logo.png<?php  } ?>" width="111" height="45" border="0" alt="" class="png"></a></h1>
...
<ul >
				...
				<li onClick="navmove('#about','3')"><a href="/vip/baojia.html" title="价格体系">价格体系</a></li>
                <li onClick="navmove('#news','4')"><a href="http://bbs.b2ctui.com/forum.php" title="程序下载">程序下载</a></li>
              
				<li onClick="navmove('#login','4')"><a href="/member.php?act=register&" title="注册">会员注册</a></li>
                <li onClick="navmove('#login','4')"><a href="/member.php?act=login&" title="登陆">会员登陆</a></li>
...
<div class="infocus">
	<div class="focus_pic">
		<ul >
		<li><a href="/#login"><img src="./resource/weidongli/images/pic01.jpg" width="1920" height="612" alt="微信营销新时代"></a></li>
		<li><a ><img src="./resource/weidongli/images/pic02.jpg" width="1920" height="612" alt=""></a></li>
		<li><a ><img src="./resource/weidongli/images/pic03.jpg" width="1920" height="612" alt="微信营销新时代"></a></li>
		<li><a href="/"><img src="./resource/weidongli/images/pic04.jpg" width="1920" height="612" alt="<?php  echo $_W['setting']['copyright']['sitename'];?>新时代"></a></li>
		</ul>
	</div>
...
<div class="link_btn">
<ul >
<li><a href="http://wpa.qq.com/msgrd?V=3&amp;Uin={weixin::C('site_qq')}&amp;Site=<?php  echo $_W['setting']['copyright']['sitename'];?>&amp;Menu=yes&amp;from=discuz" target="_blank"title="" class="link_qq"></a></li>
...
<div class="footbg">
<div class="foot">
<p class="fl">Powered by <strong><a href="/" target="_blank">B2CTUI.COM</a></strong> <em>WDL2.0616</em>&nbsp--&copy; 2001-2014 <a href="/" target="_blank"><a href="/" target="_blank">微动力</a></a></p>
<p class="fr"><a href="/" title="">网站首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="archiver/" >Archiver</a>
&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://bbs.b2ctui.com/qmx8_buy_usergroup-vip.html" >申请入住</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://bbs.b2ctui.com/forum-2-1.html" >软件下载</a>&nbsp;&nbsp;|&nbsp;&nbsp;
<a href="http://wpa.qq.com/msgrd?v=3&uin={weixin::C('site_qq')}&site=qq&menu=yes" target="_blank">接口定制</a>&nbsp;|&nbsp;
				<a href="http://wpa.qq.com/msgrd?v=3&uin={weixin::C('site_qq')}&site=qq&menu=yes" target="_blank">微信托管</a>&nbsp;|&nbsp;
				<a href="http://bbs.b2ctui.com" target="_blank">微站论坛</a>
...
<div class="qqico">
 <a href="http://wpa.qq.com/msgrd?V=3&amp;Uin={weixin::C('site_qq')}&amp;Site=<?php  echo $_W['setting']['copyright']['sitename'];?>&amp;Menu=yes&amp;from=discuz" title="点击立即咨询" target="_blank"><img src="./resource/weidongli/images/qqico.png" width="67" HEIGHT="65" class="png" ALT="点击立刻咨询"></a></div></div></div>
