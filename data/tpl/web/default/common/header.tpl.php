...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>微动力 - 微信公众平台自助引擎 -  Powered by BBS.B2CTUI.COM<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
...
<meta name="description" content="<?php  if(empty($_W['setting']['copyright']['description'])) { ?>微信公众平台自助引擎，简称微动力，微动力是一款免费开源的微信公众平台管理系统。<?php  } else { ?><?php  echo $_W['setting']['copyright']['description'];?><?php  } ?>" />
