...
<link href="./resource/weidongli/css/global.css" rel="stylesheet" type="text/css" />
<link href="./resource/weidongli/css/login.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="./resource/weidongli/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="./resource/weidongli/js/jquery-ui.js"></script>
<script>
...
<div class="main1000" > <img class="phone" alt="phone" src="./resource/weidongli/images/phone.png" id="zll" style="top:120px;display: inline;">
    <p class="txt1"><img src="./resource/weidongli/images/login_huanyin.png" width="251" height="109" /></p>
 ...
 <p class="reg_pic"><a href="<?php  echo create_url('member/register')?>"><img src="./resource/weidongli/images/reg.jpg" width="175" height="38" /></a><?php  } ?></p>
      </div>
  </form>
    <div class="yinying"><img src="./resource/weidongli/images/login_yiyin.png" width="320" height="4" /></div>
    <div class="news">
      <div class="gr"></div>
      <ul>
        <li style=" width:545px;">
          <div class="w545">
            ...
            <div class="products-desc">
              <h3 class="title">什么是微动力</h3>
              <div class="desc"> 微动力是一个集微信公众接口、微信达人、微信资讯， <br>
